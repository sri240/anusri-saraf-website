    ...
    <div class="activities"  style={{clear:"both"}}>
      ...
      <div class="technology"></div>
        ...
        <p style = {{color: 'rgb(180, 180, 240)',
          marginBottom: "0px",
          clear: "both",
          marginRight: "460px"}}><i>programming</i> • i am proficient in numerous programming languages, including
      ...
      <div class="arts">
        ...
        <p style = {{color: '#f2aebe',
          marginBottom: "20px",
          clear: "both",
          marginLeft: "460px"}}><i>music</i> • my instruments of choice include voice, violin, piano, guitar, and ukulele. i compose, 
